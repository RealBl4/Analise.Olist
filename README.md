...
![Gráfico de Faturamento por Estado](Faturamento por Estado.png)
...
![GIF Interativo do Treemap](treemap gif.gif)
...
![Gráfico de Performance Logística](Atraso Médio na Entrega por Estado (Dias).png)
